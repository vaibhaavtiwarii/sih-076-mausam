...
export const weatherApi = {
  subscribeToAlerts: (data) => api.post('/api/subscribers', data), // { name, phone, city, persona }
sendDemoAlert: (data) => api.post('/api/subscribers/demo-alert', data), // { phone, city, persona }
  subscribeToAlerts: (data) => api.post('/api/subscribers', data), // { name, phone, city, persona }
